...
namespace DependencyTracker.Data.Services
{
    public interface IApplicationService
    {
        ...
        IEnumerable<Application> Search(string term, string environment, string status, string criticality, int? categoryId, string version, int? technologyId, int? familyId, int? tagId, int? applicationTypeId, string sortBy, bool includeDeleted);
